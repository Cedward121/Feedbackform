...
class EmployeeFeedback(models.Model):
    ...
    month_year = models.CharField(max_length=7, default=date.today().strftime('%Y-%m'))  # Format: YYYY-MM
    ...
    def __str__(self):
        return f"{self.Employee_name} - {self.overall_performance} ({self.month_year})"
